...
export default function UsuarioView(){
  ...
  const handleEditar = async () => {
    if (!usuarioEditarId) return;
    try {
      await controller.actualizarUsuario(usuarioEditarId, nombre);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>INSERT, SELECT, UPDATE Y DELETE</Text>
      ...
      <View style={styles.insertSection}>
        <Text style={styles.sectionTitle}>
          {modoEdicion ? "Editar Usuario" : "Insertar Usuario"}
        </Text>
        <TextInput
          style={styles.input}
        ...
        <TouchableOpacity
          ...
          onPress={modoEdicion ? handleEditar : handleAgregar}
          disabled={guardando}
        >
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptySubtext}>Agrega uno arriba</Text>
              </View>
            }
